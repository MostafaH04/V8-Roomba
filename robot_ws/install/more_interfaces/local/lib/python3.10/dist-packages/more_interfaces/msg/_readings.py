...
class Metaclass_Readings(type):
    """Metaclass of message 'Readings'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'more_interfaces.msg.Readings')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__readings
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__readings
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__readings
            cls._TYPE_SUPPORT = module.type_support_msg__msg__readings
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__readings
...
class Readings(metaclass=Metaclass_Readings):
    """Message class 'Readings'."""
    ...
    @gyr_x.setter
    def gyr_x(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'gyr_x' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'gyr_x' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._gyr_x = value
    ...
    @gyr_y.setter
    def gyr_y(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'gyr_y' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'gyr_y' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._gyr_y = value
    ...
    @gyr_z.setter
    def gyr_z(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'gyr_z' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
