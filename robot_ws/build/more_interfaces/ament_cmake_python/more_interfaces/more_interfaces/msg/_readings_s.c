...
bool more_interfaces__msg__readings__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("more_interfaces.msg._readings.Readings", full_classname_dest, 38) == 0);
  }
  more_interfaces__msg__Readings * ros_message = _ros_message;
  {  // acc_x
  ...
  {  // gyr_x
    PyObject * field = PyObject_GetAttrString(_pymsg, "gyr_x");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->gyr_x = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // gyr_y
    PyObject * field = PyObject_GetAttrString(_pymsg, "gyr_y");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->gyr_y = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // gyr_z
    PyObject * field = PyObject_GetAttrString(_pymsg, "gyr_z");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
...
{
  /* NOTE(esteve): Call constructor of Readings */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("more_interfaces.msg._readings");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Readings");
  ...
  {  // gyr_x
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->gyr_x);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gyr_x", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // gyr_y
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->gyr_y);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gyr_y", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
